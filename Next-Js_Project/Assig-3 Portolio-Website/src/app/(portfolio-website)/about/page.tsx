...
import type { ProfileType } from "@/app/(portfolio-website)/types/index";
              ...
              <div className="flex flex-col lg:justify-self-center justify-self-start gap-y-8 lg:order-1 order-none mb-12">
                <div>
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-x-2 border border-transparent hover:border-zinc-700 rounded-md duration-200 py-2 text-center cursor-cell font-medium"
                  >
